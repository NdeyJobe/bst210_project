...
data <- data %>%
  rowwise() %>%
  mutate(mortality_count_neonatal = as.numeric(mortality_rate_neonatal) * as.numeric(birth_rate) * as.numeric(population))
...
write.csv(world_data, file = "bst210_project_data.csv", row.names = FALSE)
```
